...
#      weird mismatch stating from lfads.py#381
       print('Provided mat_init_value must have shape [%d, %d].' \
             'So changing the size accordingly' %(in_size, out_size))
       mat_init_value = mat_init_value.transpose() 
